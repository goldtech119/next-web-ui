...
export const DiscordIcon: React.FC<SvgIconProps> = ({ height = 24, width = 24, ...props }) => (
	<SvgIcon xmlns='http://www.w3.org/2000/svg' x='0px' y='0px' viewBox='0 0 24 24' height={height} width={width} {...props}>
